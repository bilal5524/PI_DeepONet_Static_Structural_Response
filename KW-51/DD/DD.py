...
Output_new_two = mat_data['Output_Transform'].astype(np.float64)
...
for idx, fraction_train in enumerate([0.2]):
    ...
    losshistory, train_state = model.train(iterations=600000, batch_size=batch_size)
    ...
    plt.savefig('Err_hist_DeepONet ' + str(Value) + '.jpg', dpi=300)